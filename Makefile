...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/09/19 16:54:47 by efedoryc          #+#    #+#              #
#    Updated: 2016/11/21 15:00:02 by efedoryc         ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = libft.a
WWW = -Wall -Wextra -Werror -fPIC
FILE_SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
			...
			ft_isspace.c ft_nbrsize.c
FILE_O =	ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
